...
extern volatile bool __rt_wakeup;
extern void __xnsched_run_handler(void);

/* Used to synchronize wakeup Linux thread during termination. */
extern volatile bool __stable_for_wakeup;

extern void xnthread_do_task_create(void);
...
extern struct list_head list_threads;
...
extern cpumask_t xnsched_realtime_cpus;
...
{
	XENO_BUG_ON(COBALT, !irqs_disabled());
