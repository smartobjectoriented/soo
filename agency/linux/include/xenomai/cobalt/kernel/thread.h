...
struct xnthread {
	...
	struct list_head joinees;	/* All xnthreads which are waiting on me. */
	...
	/* Main list of xnthread instances. Each xnthread is in this list until
	 * their completion, i.e. after they moved to zombie state, and finally
