...
#define EC_INFO(fmt, args...) \
    lprintk(KERN_INFO "EtherCAT: " fmt, ##args)
...
#define EC_ERR(fmt, args...) \
    lprintk(KERN_ERR "EtherCAT ERROR: " fmt, ##args)
...
#define EC_WARN(fmt, args...) \
    lprintk(KERN_WARNING "EtherCAT WARNING: " fmt, ##args)
...
#define EC_DBG(fmt, args...) \
    lprintk(KERN_DEBUG "EtherCAT DEBUG: " fmt, ##args)
