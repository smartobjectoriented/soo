...
struct ec_master {
    ...
    rtdm_sem_t master_sem; /**< Master semaphore. */

    /* Used during probe on CPU #0 */
    struct semaphore nort_master_sem;
    ...
    unsigned int num_devices; /**< Number of devices. Access this always via
                                ...
                                optimized! */
#endif
    rtdm_sem_t device_sem; /**< Device semaphore. */
    ...
    rtdm_sem_t scan_sem; /**< Semaphore protecting the \a scan_busy
    ...
    rtdm_sem_t config_sem; /**< Semaphore protecting the \a config_busy
    ...
    struct list_head ext_datagram_queue; /**< Queue for non-application
                                           datagrams. */
    rtdm_sem_t ext_queue_sem; /**< Semaphore protecting the \a
                                      ext_datagram_queue. */
    ...
    rtdm_task_t thread; /**< Master thread. */

#ifdef EC_EOE
    rtdm_task_t eoe_thread; /**< EoE thread. */
    struct list_head eoe_handlers; /**< Ethernet over EtherCAT handlers. */
#endif

    rtdm_sem_t io_sem; /**< Semaphore used in \a IDLE phase. */
