 ...
 */
#define EC_AL_STATE_CHANGE_TIMEOUT 10 /* OpenCN - original value: 5 */
                               ...
                               /**< finite state machine */)
{
    ...
    if (datagram->working_counter == 0) {
        if (datagram->jiffies_received - fsm->jiffies_start >= 3 * RTDM_HZ) {
                                ...
                                /**< finite state machine */)
{
    ...
    if (datagram->jiffies_received - fsm->jiffies_start >=
            EC_AL_STATE_CHANGE_TIMEOUT * RTDM_HZ) {
