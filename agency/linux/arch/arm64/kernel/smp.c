...
asmlinkage notrace void secondary_start_kernel(void)
{
	...
	if (cpu == AGENCY_RT_CPU) {
		...
		printk("%s: waiting on CPU %d for starting Xenomai initialization ...\n", __func__, smp_processor_id());
...
/*
 * Trigger a TASK_CREATE IPI to CPU #1 to proceed with the initialization/starting of an xnthread.
 */
