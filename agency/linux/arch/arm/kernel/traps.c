...
extern void linux0_hypervisor_callback(void);
...
void __init early_trap_init(void *vectors_base)
{
	...
	ret = hypercall_trampoline(__HYPERVISOR_set_callbacks, (unsigned long) linux0_hypervisor_callback, (unsigned long) domcall, 0, 0);
	BUG_ON(ret < 0);
