...
/* SOO.tech */
void __ipipe_assign_chip_timer(ipipe_irqdesc_t *irqdesc) {
	irqdesc->irq_data.chip = &bcm2836_arm_irqchip_timer;
...
static void __init bcm2836_arm_irqchip_smp_init(void)
{
	...
	/* SOO.tech */
	cpurthp_setup_state(CPUHP_AP_IRQ_BCM2836_STARTING, "irqchip/bcm2836:starting", bcm2836_cpu_starting, bcm2836_cpu_dying);
}
#else
