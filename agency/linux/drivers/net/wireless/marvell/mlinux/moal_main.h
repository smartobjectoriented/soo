 ...
 */
static inline void
woal_timer_handler(struct timer_list *fcontext)
{
	pmoal_drv_timer timer = from_timer(timer, fcontext, tl);
...
mlan_status woal_auto_reconnect_cfg(moal_private *priv, t_u8 cfg_mode,
