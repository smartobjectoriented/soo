...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(3, 6, 0)
	/* SOO.tech */
	/* Encapsulate in WIFI_DIRECT_SUPPORT || DEBUG_LEVEL2 to avoid warning */
#if defined(WIFI_DIRECT_SUPPORT) || defined(DEBUG_LEVEL1) || defined(DEBUG_LEVEL2)
	struct net_device *dev = wdev->netdev;
#endif /* WIFI_DIRECT_SUPPORT || DEBUG_LEVEL2 */
#endif
	ENTER();
