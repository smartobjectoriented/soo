				 ...
				 RxReorderTbl *rx_reor_tbl_ptr)
{
	...
	/*
	 * Here, we force the delay to 100ms to avoid handling 11n reordering issues too slowly,
	 * in most cases unicast packets that are coming in conjunction with broadcast packets.
	 */
	min_flush_time = 100;
