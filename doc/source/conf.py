...
copyright = u'2021, Daniel Rossier'
...
latex_documents = [('index', 'doc.tex', u'doc Documentation', u'Daniel Rossier', 'manual')]
...
man_pages = [('index', 'doc', u'doc Documentation', [u'Daniel Rossier'], 1)]
