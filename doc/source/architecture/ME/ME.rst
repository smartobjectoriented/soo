...
+-----------------------+-----------------------------------------------------------------------------+
|| *0x0020000000000003* || SOO.wagoled is used to communicate with the WAGO PFC and redirect          |
||                      || the received commands to the Wago ecosystem.                               |
+-----------------------+-----------------------------------------------------------------------------+
| *0x0020000000000004*  | SOO.switch is used to propagate a switch event through the SOO ecosystem.   |
+-----------------------+-----------------------------------------------------------------------------+
