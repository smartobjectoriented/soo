...
int cb_pre_propagate(soo_domcall_arg_t *args) {
	...
	if (g_data_temp->need_propagate) {

		lprintk("ME SOO.indoor migrate !!\n");
	...
	g_data_temp->need_propagate = false;
...
void callbacks_init(void) {
	...
	g_data_temp = &localData->temp;
	memcpy(localData->type, SOO_indoor_spid, SPID_SIZE);
