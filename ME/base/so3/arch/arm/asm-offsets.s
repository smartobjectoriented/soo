...
@ -I soo/include -imultilib . -imultiarch arm-linux-gnueabihf
@ -iprefix /opt/toolchains/arm-linux-gnueabihf_6.4.1/bin/../lib/gcc/arm-linux-gnueabihf/6.4.1/
@ -isysroot /opt/toolchains/arm-linux-gnueabihf_6.4.1/bin/../arm-linux-gnueabihf/libc
@ -D __KERNEL__ -U arm -D BITS_PER_LONG=32 -D KBUILD_STR(s)=#s
@ -D KBUILD_BASENAME=KBUILD_STR(asm_offsets)
@ -include include/generated/autoconf.h
@ -isystem /opt/toolchains/arm-linux-gnueabihf_6.4.1/bin/../lib/gcc/arm-linux-gnueabihf/6.4.1/include
...
.LASF28:
	.ascii	"/home/reds/soo/ME/base/so3\000"
