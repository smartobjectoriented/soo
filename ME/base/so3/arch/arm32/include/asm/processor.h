...
/*
 * Used to check pending IRQs after renabling interrupts (avz may have got the in-the-loop IRQ,
 * but as IRQs are disabled in the domain, the IRQ remains pending).
 */
extern bool in_upcall_progress;
