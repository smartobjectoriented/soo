...
typedef struct __name##_back_ring __name##_back_ring_t;			\
									\
static inline __req_t *__name##_ring_request(__name##_front_ring_t *__name##_front_ring) { 	\
...
RING_PUSH_REQUESTS(__name##_front_ring);								\
													...
													\
static inline __rsp_t *__name##_ring_response(__name##_front_ring_t *__name##_front_ring) {	\
